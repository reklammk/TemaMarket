...
class _CustomerStorefrontPageState extends State<CustomerStorefrontPage> {
  ...
  final List<Map<String, dynamic>> _popularProducts = [
    ...
    {
      'id': 12,
      'name': "Yumurta 30'Lu (M)",
      'price': 139.90,
      'orig_price': 149.90,
      'sub_brand': 'Sarkuteri',
      'rating': 5.0,
      'badge': '14-18 AĞUSTOS FIRSATI',
  ...
  final List<Map<String, dynamic>> _discountedProducts = [
    ...
    {
      'id': 13,
      'name': "Yumurta 30'Lu (L)",
      'price': 149.90,
      'orig_price': 169.90,
      'sub_brand': 'Sarkuteri',
      'discount_rate': '%12 İNDİRİM',
  ...
  final List<Map<String, dynamic>> _products = [
    ...
    {
      'id': 7,
      'name': 'Beypiliç Piliç Sarma 1 Kg',
      'price': 169.90,
      'orig_price': 189.90,
      'sub_brand': 'Kasap',
    ...
    {
      'id': 8,
      'name': 'Beypiliç Kelebek Pirzola 1 Kg',
      'price': 149.90,
      'orig_price': 169.90,
      'sub_brand': 'Kasap',
    ...
    {
      'id': 9,
      'name': 'Beypiliç Parmak Bonfile 1 Kg',
      'price': 179.90,
      'orig_price': 199.90,
      'sub_brand': 'Kasap',
    ...
    {
      'id': 15,
      'name': 'Komili Riviera Zeytinyağı 5 Lt',
      'price': 1199.00,
      'orig_price': 1395.00,
      'sub_brand': 'Manav',
      'image': 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=400&q=80',
    ...
    {
      'id': 16,
      'name': 'Kristal Riviera Zeytinyağı 5 Lt',
      'price': 1199.90,
      'orig_price': 1379.90,
      'sub_brand': 'Manav',
      'image': 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=400&q=80',
    ...
    {
      'id': 17,
      'name': 'Tema Pilavlık Bulgur 4 Kg',
      'price': 109.90,
      'orig_price': 169.90,
      'sub_brand': 'Manav',
    ...
    {
      'id': 18,
      'name': 'Tema Kırmızı Mercimek Futbol 2.5 Kg',
      'price': 109.90,
      'orig_price': 165.90,
      'sub_brand': 'Manav',
    ...
    {
      'id': 19,
      'name': 'Tema Osmancık Pirinç 2.5 Kg',
      'price': 159.90,
      'orig_price': 229.90,
      'sub_brand': 'Manav',
      'image': 'https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=400&q=80',
    ...
    {
      'id': 20,
      'name': 'Deryalım Osmancık Pirinç 4 Kg',
      'price': 199.90,
      'orig_price': 259.90,
      'sub_brand': 'Manav',
      'image': 'https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=400&q=80',
    ...
    {
      'id': 21,
      'name': 'Yayla Aşurelik Buğday 2 Kg',
      'price': 59.99,
      'orig_price': 79.99,
      'sub_brand': 'Manav',
    ...
    {
      'id': 22,
      'name': 'Barilla Penne Rigate Makarna 500 Gr',
      'price': 39.99,
      'orig_price': 52.99,
      'sub_brand': 'Manav',
    ...
    {
      'id': 23,
      'name': 'Eti Çikolata Bol Sütlü 60 Gr',
      'price': 49.99,
      'orig_price': 72.99,
      'sub_brand': 'Fırın',
    ...
    {
      'id': 24,
      'name': 'Gürsoy Kakaolu Fındık Kreması 700 Gr',
      'price': 159.90,
      'orig_price': 219.90,
      'sub_brand': 'Sarkuteri',
    ...
    {
      'id': 25,
      'name': 'Lipton Yellow Label Dökme Çay 1 Kg',
      'price': 339.90,
      'orig_price': 379.90,
      'sub_brand': 'Icecek',
    ...
    {
      'id': 26,
      'name': 'Tukaş Domates Salçası 830 Gr',
      'price': 59.99,
      'orig_price': 64.50,
      'sub_brand': 'Manav',
    ...
    {
      'id': 27,
      'name': 'Tema Kokteyl Extra Kuruyemiş 1 Kg',
      'price': 899.90,
      'orig_price': 999.90,
      'sub_brand': 'Fırın',
    ...
    {
      'id': 29,
      'name': 'Coca-Cola Zero Sugar 2.5 Lt',
      'price': 59.99,
      'orig_price': 89.99,
      'sub_brand': 'Icecek',
    ...
    {
      'id': 30,
      'name': 'Karlıdağ Geleneksel Tereyağı 1 Kg',
      'price': 499.99,
      'orig_price': 599.90,
      'sub_brand': 'Sarkuteri',
    ...
    {
      'id': 31,
      'name': 'Kuru Sele Siyah Zeytin 1 Kg',
      'price': 399.90,
      'orig_price': 559.90,
      'sub_brand': 'Sarkuteri',
      'image': 'https://images.unsplash.com/photo-1541458385327-f3a388478492?auto=format&fit=crop&w=400&q=80',
    },
    {
      'id': 32,
      'name': 'Izgara Yeşil Zeytin 1 Kg',
      'price': 349.90,
      'orig_price': 459.90,
      'sub_brand': 'Sarkuteri',
      'image': 'https://images.unsplash.com/photo-1541458385327-f3a388478492?auto=format&fit=crop&w=400&q=80',
    ...
    {
      'id': 33,
      'name': 'Marmara Birlik Gemlik Zeytin 1 Kg',
      'price': 399.90,
      'orig_price': 499.90,
      'sub_brand': 'Sarkuteri',
      'image': 'https://images.unsplash.com/photo-1541458385327-f3a388478492?auto=format&fit=crop&w=400&q=80',
    ...
    {
      'id': 35,
      'name': 'Namet Dana Kangal Klasik Sucuk 200 Gr',
      'price': 199.90,
      'orig_price': 239.90,
      'sub_brand': 'Kasap',
      'image': 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=400&q=80',
          ...
          children: navItems.map((item) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: id == 2 && _flags.sanalMarket && _cart.isNotEmpty
                      ? Badge(
